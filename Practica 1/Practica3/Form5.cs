...
namespace Practica3
{
    public partial class Form5 : Form
    {
        ...
        private void btnLimpiar_Click(object sender, EventArgs e)
        {
            ...
            txtHoras.Clear();
            txtValorhora.Clear();
            lblTotalplanilla.Text = String.Empty;
        ...
        private void txtHoras_Validating(object sender, CancelEventArgs e)
        {
            if (txtHoras.Text == "")
            {
                e.Cancel = true;
                txtHoras.Focus();
                errorProvider1.SetError(txtHoras, "Ingrese una cantidad válida.");
            }
        }
        ...
        private void txtValorhora_Validating(object sender, CancelEventArgs e)
        {
            if (txtValorhora.Text == "")
            {
                e.Cancel = true;
                txtValorhora.Focus();
                errorProvider1.SetError(txtValorhora, "Ingrese una hora válida.");
            }
        }
